...
\begin{equation}
H(s)=\frac{V_{out}}{V_{in}}=--\frac{R_{2}R_{3}\omega_{p}a_{0}}{-R_{1}R_{2}\left(\omega_{p}+s\right)+R_{1}R_{3}\omega_{p}a_{0}+R_{1}R_{3}\left(\omega_{p}+s\right)+R_{2}R_{3}\left(\omega_{p}+s\right)}\label{eq:1_a_1}
\end{equation}

\[
H(s)=-\frac{5\cdot10^{15}}{100\,10^{6}s+502\text{\texttimes}10^{12}}\,Caso\,1
\]

\[
H(s)=-\frac{502\text{\texttimes}10^{12}}{100\text{\texttimes}10^{6}s+502\text{\texttimes}10^{12}}\,Caso\,2
\]

\[
H(s)=-\frac{5.0272\cdot10^{15}}{10\text{\texttimes}10^{9}s+5\cdot10^{16}}\,Caso\,3
\]
...
\caption{Medición de la transferencia}
