...
\begin{figure}[H]
\begin{centering}
\includegraphics[scale=0.5]{Resources1a/zinpm1}\includegraphics[scale=0.5]{Resources1a/zinpm1_sim}
\par\end{centering}
\caption{Calculo, simulación y medición del modulo de la impedancia de entrada
caso 1}
\end{figure}

\begin{figure}[H]
\begin{centering}
\includegraphics[scale=0.5]{Resources1a/zinpp1}\includegraphics[scale=0.5]{Resources1a/zinpp1_sim}
\par\end{centering}
\caption{Calculo, simulación y medición de la fase de la impedancia de entrada
caso 1}
...
\begin{figure}[H]
\begin{centering}
\includegraphics[scale=0.5]{Resources1a/zinpm2}\includegraphics[scale=0.5]{Resources1a/zinpm2_sim}
\par\end{centering}
\caption{Calculo, simulación y medición del modulo de la impedancia de entrada
caso 2}
\end{figure}
...
\begin{figure}[H]
\begin{centering}
\includegraphics[scale=0.5]{Resources1a/zinpp2}\includegraphics[scale=0.5]{Resources1a/zinpp2_sim}
\par\end{centering}
\caption{Calculo, simulación y medición de la fase de la impedancia de entrada
caso 2}
\end{figure}
...
\begin{figure}[H]
\begin{centering}
\includegraphics[scale=0.5]{Resources1a/zinpm3}\includegraphics[scale=0.5]{Resources1a/zinpm3_sim}
\par\end{centering}
\caption{Calculo, simulación y medición del modulo de la impedancia de entrada
caso 3}
\end{figure}
...
\begin{figure}[H]
\begin{centering}
\includegraphics[scale=0.5]{Resources1a/zinpp3}\includegraphics[scale=0.5]{Resources1a/zinpp3_sim}
\par\end{centering}
\caption{Calculo, simulación y medición de la fase de la impedancia de entrada
caso 3}
\end{figure}
