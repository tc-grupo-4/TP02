...
se uso un polo dominante de 8 (Hz) (Que era lo que se observaba aproximadamente
en el grafico provisto por el graficante) y en el simulado se uso
el modelo real del LM324.
...
$2V_{cc}$, lo cual se condice con lo predicho.
...
Como se puede ver en la Figura \ref{1_a_13}, el valor de $SR=0.55836\left(\frac{V}{\mu s}\right)$,
...
de las curvas mostradas en las Figuras .
...
\begin{figure}[H]
\begin{centering}
\includegraphics[scale=0.5]{Resources1a/dcswp2sim}\includegraphics[scale=0.4]{Resources1a/DCSWEEP2MED}
\par\end{centering}
...
\begin{figure}[H]
\begin{centering}
\includegraphics[scale=0.5]{Resources1a/dcswp3sim}\includegraphics[scale=0.4]{Resources1a/DCSWEEP3MED}
\par\end{centering}
