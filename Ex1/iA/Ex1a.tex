...
\begin{figure}[H]
\begin{centering}
\includegraphics[scale=0.5]{Resources1a/zinpm1}
\par\end{centering}
\caption{Calculo y medicion del modulo de la impedancia de entrada caso 1}
\end{figure}

\begin{figure}[H]
\begin{centering}
\includegraphics[scale=0.5]{Resources1a/zinpp1}
\par\end{centering}
\caption{Calculo y medicion de la fase de la impedancia de entrada caso 1}

\end{figure}

\begin{figure}[H]
\begin{centering}
\includegraphics[scale=0.5]{Resources1a/zinpm2}
\par\end{centering}
\caption{Calculo y medicion del modulo de la impedancia de entrada caso 2}
\end{figure}

\begin{figure}[H]
\begin{centering}
\includegraphics[scale=0.5]{Resources1a/zinpp2}
\par\end{centering}
\caption{Calculo y medicion de la fase de la impedancia de entrada caso 2}
\end{figure}

\begin{figure}[H]
\begin{centering}
\includegraphics[scale=0.5]{Resources1a/zinpm3}
\par\end{centering}
\caption{Calculo y medicion del modulo de la impedancia de entrada caso 3}
\end{figure}

\begin{figure}[H]
\begin{centering}
\includegraphics[scale=0.5]{Resources1a/zinpp3}
\par\end{centering}
\caption{Calculo y medicion de la fase de la impedancia de entrada caso 3}
\end{figure}
