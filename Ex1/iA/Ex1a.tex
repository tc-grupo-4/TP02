...
ecuaciones. Estas ecuaciones se pueden ver en la figura \ref{1_a_4}.
...
\begin{figure}[H]
\begin{centering}
\includegraphics[scale=0.4]{Resources1a/dcswp1sim}
\par\end{centering}
\begin{centering}
...
\begin{figure}[H]
\begin{centering}
\includegraphics[scale=0.5]{Resources1a/DCSWEEP1MED}
\par\end{centering}
\begin{centering}
