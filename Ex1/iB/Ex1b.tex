...
\begin{figure}[H]
\begin{centering}
\includegraphics[scale=0.5]{\string"Resources1b/DC Sweep1_sim\string".png}\includegraphics[scale=0.5]{\string"Resources1b/DC Sweep1_med\string".png}
\par\end{centering}
...
\begin{figure}[H]
\begin{centering}
\includegraphics[scale=0.5]{\string"Resources1b/DC Sweep2_sim\string".png}\includegraphics[scale=0.5]{\string"Resources1b/DC Sweep2_med\string".png}
\par\end{centering}
...
\begin{figure}[H]
\begin{centering}
\includegraphics[scale=0.5]{\string"Resources1b/DC Sweep3_sim\string".png}\includegraphics[scale=0.5]{\string"Resources1b/DC Sweep3_med\string".png}
\par\end{centering}
